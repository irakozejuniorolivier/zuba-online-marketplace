<?php
/**
 * PROPERTY ORDER CONFIRMATION PAGE
 */
...
$stmt->bind_param('i', $order['property_id']);
$stmt->execute();
$result = $stmt->get_result();
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .order-number { display: inline-flex; align-items: center; gap: 8px; background: #f9fafb; padding: 10px 20px; border-radius: 10px; font-size: 14px; font-weight: 700; color: #1a1a2e; border: 1px solid #e5e7eb; }
        .order-number i { color: #f97316; }
        ...
        /* Property Info */
        .property-info { display: flex; gap: 16px; align-items: start; }
        ...
        .property-details { flex: 1; min-width: 0; }
        ...
        .property-location { display: flex; align-items: center; gap: 6px; color: #6b7280; font-size: 13px; }
        ...
        @media (max-width: 640px) {
            ...
            .order-number { font-size: 13px; padding: 8px 16px; }
...
<div class="container">
    ...
    <div class="success-card">
        ...
        <p class="success-message">
            Your property order has been submitted. We will review your payment and get back to you shortly.
        </p>
        <div class="order-number">
            <i class="fas fa-receipt"></i>
            <span>Order #<?= e($order['order_number']) ?></span>
        </div>
    </div>
    ...
    <div class="alert-box">
        ...
        <div class="alert-box-text">
            Our team will verify your payment within 24-48 hours. You will receive a notification once your order is approved. You can track your order status in the "My Orders" section.
        </div>
    </div>
    ...
    <div class="section">
        ...
        <div class="property-info">
            <?php if ($image_path): ?>
                <img src="<?= UPLOAD_URL . 'properties/' . $image_path ?>" alt="<?= e($order['property_title']) ?>" class="property-image">
            <?php else: ?>
            ...
            <div class="property-details">
                ...
                <h2 class="property-name"><?= e($order['property_title']) ?></h2>
    ...
    <div class="section">
        ...
        <div class="info-grid">
            ...
            <?php if ($order['order_type'] === 'rent'): ?>
                <div class="info-row">
                    <span class="info-label">Rent Duration</span>
            ...
            <div class="info-row">
                ...
                <span class="info-value" style="font-size: 18px; color: #f97316;"><?= formatCurrency($order['amount']) ?></span>
            </div>
        </div>
    </div>
    ...
    <div class="section">
        ...
        <?php if ($order['payment_proof']): ?>
            <div style="margin-top: 16px;">
                ...
                <img src="<?= UPLOAD_URL . 'payment_proofs/' . $order['payment_proof'] ?>" alt="Payment Proof" class="payment-proof-img">
            </div>
        <?php endif; ?>
    </div>
    ...
    <!-- Action Buttons -->
    <div class="btn-group">
        <a href="<?= SITE_URL ?>/property-orders.php" class="btn btn-primary">
            <i class="fas fa-truck"></i>
            Track Your Order
        </a>
        <a href="<?= SITE_URL ?>/properties.php" class="btn btn-secondary">
            <i class="fas fa-building"></i>
            Browse Properties
        </a>
    </div>
