...
<head>
    ...
    <title>All Properties | Zuba Online Market</title>
...
<style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .property-card { background: #fff; border-radius: 12px; overflow: hidden; border: 1px solid #e5e7eb; transition: all 0.3s; text-decoration: none; color: inherit; display: block; position: relative; }
    .property-card:hover { border-color: #f97316; box-shadow: 0 8px 16px rgba(0,0,0,0.1); transform: translateY(-4px); }
    ...
    .property-badges { display: flex; gap: 6px; margin-bottom: 8px; flex-wrap: wrap; }
    ...
    .property-title { font-size: 16px; font-weight: 600; color: #1a1a2e; margin-bottom: 8px; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden; min-height: 48px; }
    .property-location { font-size: 13px; color: #6b7280; margin-bottom: 12px; display: flex; align-items: center; gap: 4px; }
    .property-details { display: flex; gap: 12px; margin-bottom: 12px; font-size: 12px; color: #6b7280; }
    .property-detail { display: flex; align-items: center; gap: 4px; }
    .property-price { font-size: 20px; font-weight: 700; color: #f97316; }
    .property-price-period { font-size: 12px; color: #6b7280; font-weight: 400; }
...
<header class="header">
    <div class="header-content">
        ...
        <div class="header-title">
            ...
            <p><?= count($properties) ?> propert(ies) available</p>
        </div>
    </div>
</header>
    ...
    <?php if (count($properties) > 0): ?>
        <div class="properties-grid">
            <?php foreach ($properties as $property): ?>
                <a href="<?= SITE_URL ?>/property-detail.php?slug=<?= e($property['slug']) ?>" class="property-card">
                    ...
                    <?php if ($property['primary_image']): ?>
                        <img src="<?= UPLOAD_URL . 'properties/' . e($property['primary_image']) ?>" alt="<?= e($property['title']) ?>" class="property-image">
                    <?php else: ?>
                        <div class="no-image">
                    ...
                    <div class="property-content">
                        <div class="property-badges">
                            <?php if ($property['category_name']): ?>
                                <span class="badge badge-category"><?= e($property['category_name']) ?></span>
                            <?php endif; ?>
                            <span class="badge badge-type"><?= ucfirst(e($property['property_type'])) ?></span>
                            <span class="badge badge-listing"><?= ucfirst(e($property['listing_type'])) ?></span>
                        </div>
                        
                        <div class="property-title"><?= e($property['title']) ?></div>
                        
                        <div class="property-location">
                            <i class="fas fa-map-marker-alt"></i>
                            <?= e($property['city']) ?>, <?= e($property['country']) ?>
                        </div>
                        ...
                        <div class="property-details">
                            ...
                            <?php if ($property['area']): ?>
                                <div class="property-detail">
                                    <i class="fas fa-ruler-combined"></i> <?= number_format($property['area']) ?> <?= strtoupper($property['area_unit']) ?>
                                </div>
                            <?php endif; ?>
                        </div>
                        ...
                        <div class="property-price">
                            ...
                            <?php if ($property['listing_type'] == 'rent' && $property['rent_period']): ?>
                                <span class="property-price-period">/ <?= ucfirst($property['rent_period']) ?></span>
                            <?php endif; ?>
                        </div>
                    </div>
                </a>
